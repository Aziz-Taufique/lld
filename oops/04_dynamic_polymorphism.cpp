...
public:
    ...
    virtual void accelerate(int spped) = 0;
...
public:
    ...
    void accelerate() override
    {
        ...
        currentSpeed += 20;
        std::cout << "Accelerating to " << currentSpeed << std::endl;
    }
    ...
    void brake() override
    {
        ...
        if (currentSpeed < 0)
            currentSpeed = 0;
        std::cout << "Breaking! speed is now " << currentSpeed << std::endl;
    }
...
public:
    ...
    void accelerate() override
    {
        ...
        if (batteryLevel == 0)
        {
            std::cout << "Cannot accelerate! battey is dead" << std::endl;
            return;
        }
        batteryLevel -= 10;
        currentSpeed += 15;
        std::cout << "Acceleration! curren speed is " << currentSpeed << std::endl;
    }
    ...
    void brake() override
    {
        ...
        std::cout << "Break is apply. Now current speed is " << currentSpeed << std::endl;
    }
};
...
int main()
{
    ...
    electricCar->openCloseWindow();
    electricCar->closeOpenDoors(2);
    electricCar->closeAllDoors();
    electricCar->display();
